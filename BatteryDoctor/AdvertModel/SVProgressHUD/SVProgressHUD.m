...
static const CGFloat SVProgressHUDDefaultAnimationDuration = 0.2;
...
- (UIView*)hudView {
    ...
    _hudView.backgroundColor = [UIColor lightGrayColor];//[UIColor colorWithRed:230/255.0 green:230/255.0 blue:230/255.0 alpha:1];
