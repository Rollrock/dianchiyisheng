...
-(void)buildLayout
{
    self.backgroundColor = COLOR_FROM_HEX(0x2E94B9); //[UIColor colorWithRed:190/255.0f green:232/255.0f blue:231/255.0f alpha:0.8];
    self.layer.cornerRadius = self.bounds.size.width/2.0f;
    self.layer.masksToBounds = true;
    
    CGFloat waveWidth = self.bounds.size.width-4;
    ...
    _textLabel.font = [UIFont boldSystemFontOfSize:60];
